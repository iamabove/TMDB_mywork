...
import PageLayoutId from "../../components/PageLayoutId";
import { AiFillStar } from "react-icons/ai";
import useScroll from "../../hooks/useScroll";
import ScrollButtons from "../../components/ScrollButtons";
import VideoBox from "../../components/VideoBox";
import { ImageBox, MediaCard } from "../../components";
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mt-4">
          ...
          {results.length > 0 ? (
            <div className="position-relative">
              ...
              {results.length > 4 && <ScrollButtons scroll={scroll} />}
              {showModal && (
                <VideoBox
        ...
        <div className="mt-4">
          <h1 className="text-secondary fs-6 mt-3 mb-3">Cast</h1>
          <div className="position-relative">
            <div
              className="d-flex scrollbody"
              style={{
        ...
        <div className="mt-4">
          <h1 className="text-secondary fs-6 mt-3 mb-3">Recommendations</h1>
          {resultsB.length > 0 ? (
            <Row className="gy-2">
              {resultsB.map((movie) => (
